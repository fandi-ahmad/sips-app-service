...
const getAllSuratRumah = async (req, res) => {
    try {
        const dataSurat = await sequelize.query( /*sql*/ `
            ...
            WHERE surats.nama_surat = "surat keterangan belum memiliki rumah"
        `)
...
const createSuratRumah = async (req, res) => {
    try {
        const {
            ...
            no_surat_pengantar, tgl_surat_pengantar
...
module.exports = { getAllSuratRumah, createSuratRumah }